...
\begin{document}
	...
	\begin{mytheorem}\label{satz:fehler-kruemmung}
		...
		\end{align*}
		gegeben, wobei $d(\xi_{i-1},\xi_{i})$ der Abstand zwischen $\xi_{i-1}$ und $\xi_{i}$ ist und $M$ die Menge der Zerlegungen von $[a,b]$ ist. F\"ur ein Intervall $[u,v]:a\leq u< v\leq b$ und eine Zerlegung $Z$ von $[u,v]$ gilt:
		\begin{align*}
