...
\begin{document}
	...
	\end{itemize}
	\section{Abschneiden eines Intervalls}\label{trapez}
	...
	\begin{mybeispiel}
		...
		\begin{bemerkung}
			Damit der Fehler minimal ist, soll $\varepsilon_T \approx T\varepsilon_h$ gelten. D. h. bei einer gegebenen Anzahl an Funktionsauswertungen kann man T bzw. h wie im folgenden Plot gewählt. Anders angeschrieben soll also $h \approx \sqrt{\frac{12e^{-T}}{T}}$ bzw. $n \approx \sqrt{\frac{T^{3}}{12e^{-T}}}$ gelten.
		\end{bemerkung}
