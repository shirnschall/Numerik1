...
\begin{document}
	...
	\lstinputlisting[language=c,firstline=16,lastline=29,label={aufgabed-code-main},caption={M\"ogliche Implementierung von \cref{aufgabec-satz} - main.cpp}]{../code/aufgabe-d/main.cpp}
